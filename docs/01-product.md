...
4. **Monitor** (pool page): price, market cap, reserve, progress to graduation, bonding curve with the pool's position, live price chart (GeckoTerminal or DexScreener, falling back to a chart from our own decoded swaps), base fee now and time left in the opening window, fees earned per party, backing, recent trades, issuer controls, post-graduation LP terms.
